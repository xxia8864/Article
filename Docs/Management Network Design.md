...
In most infrastructure designs, the management (MGMT) network is treated as an afterthought—just another VLAN with a /24 and some ACLs.

But this segment is arguably the most critical part of the entire network. 

When things go wrong—and they eventually will—the ability to access, observe, and control infrastructure determines whether you’re performing a clean recovery or flying blind in a crisis.
